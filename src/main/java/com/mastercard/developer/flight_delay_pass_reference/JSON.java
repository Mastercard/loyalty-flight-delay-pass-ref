...
public class JSON {
    ...
    public <T> T deserialize(String body, Type returnType) {
        try {
            ...
            /* Fallback processing when failed to parse JSON form response body: return the response body string directly for the String return type */
